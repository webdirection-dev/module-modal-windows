...
window.addEventListener('DOMContentLoaded', () => {
    const modalTimeoutId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_0__.openModal)('.modal', 'modalTimeoutId'), 50000);
    (0,_modules_modal__WEBPACK_IMPORTED_MODULE_0__.default)('[data-modal]', '.modal', modalTimeoutId);
});
